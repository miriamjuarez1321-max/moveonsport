...
<section class="collection-hero">
    ...
    <div class="filters">
        ...
        <a href="{{ route('collections.hombre', ['categoria' => 'Tenis']) }}" class="{{ $categoria === 'Tenis' ? 'active' : '' }}">Tenis</a>
        <a href="{{ route('collections.hombre', ['categoria' => 'Sudaderas']) }}" class="{{ $categoria === 'Sudaderas' ? 'active' : '' }}">Sudaderas</a>
    </div>
</section>
        ...
        <div class="product-card">
            ...
            <div class="card-body">
                ...
                @php
                    ...
                    // Si es accesorio, no requiere talla (según lógica previa)
